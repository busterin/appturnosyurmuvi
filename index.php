...
<div class="container">
    ...
    <div class="tabs">
        ...
        <button class="tab-button" onclick="showTab('registro')" id="registro-btn">Registro</button>
        <button class="tab-button" onclick="showTab('calendario')" id="calendario-btn">Calendario</button>
    </div>
    ...
    <div id="registro" class="tab-content">
        ...
        <form id="turno-form">
            ...
            <select id="trabajador">
                <option value="__nuevo__">+ Añadir monitor/a</option>
            </select>
